...
// Check the user's role (assuming it's stored as 'role' in the user table)
$user_role = $user['role'];
?>
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
                        ...
                        if (mysqli_num_rows($rooms_result) > 0) {
                            while ($rooms = mysqli_fetch_assoc($rooms_result)) { ?>
                                <tr>
                                    ...
                                    <td>
                         <!--  here show the buttons based on user role-->
                                    <?php if ($user_role == 'admin') { ?>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <form role="form" id="advancePayment">
                                ...
                                <button type="submit" class="btn btn-primary pull-right">Cash & Check In</button>
                                <button type="submit" class="btn btn-primary pull-left">Mpesa & Check In</button>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <table class="table table-responsive table-bordered">
                                ...
                                <tr>
                                    <td><b>Accomodation Total</b></td>
                                    <td id="getTotalPrice_n"></td>
                                </tr>
                                <tr>
                                    <td><b>Accomodation Balance</b></td>
                                    <td id="getRemainingPrice_n"></td>
                                </tr>

                                <tr>
                                    <td><b>Laundry Cost</b></td>
                                    <td id="getLaundryCost_n"></td>
                                </tr>
                                </tbody>
                            </table>
                            <form role="form" id="checkOutRoom_n" data-toggle="validator">
                                ...
                                <button type="submit" class="btn btn-primary pull-right">Cash & Checkout</button>
                                <button type="submit" class="btn btn-primary pull-left">Mpesa & Check Out</button>
    ...
    <div class="row">
        <div class="col-sm-12">
        <p class="back-link">Developed By MCLOGIC SYSTEM</p>
        </div>
    </div>
